(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function n(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerpolicy&&(o.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?o.credentials="include":r.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=n(r);fetch(r.href,o)}})();function u(){}function E(e){return e()}function L(){return Object.create(null)}function m(e){e.forEach(E)}function I(e){return typeof e=="function"}function N(e,t){return e!=e?t==t:e!==t||e&&typeof e=="object"||typeof e=="function"}function H(e){return Object.keys(e).length===0}function P(e,t,n){e.insertBefore(t,n||null)}function j(e){e.parentNode&&e.parentNode.removeChild(e)}function T(e){return document.createElement(e)}function A(e){return Array.from(e.childNodes)}let v;function d(e){v=e}const c=[],w=[],h=[],k=[],M=Promise.resolve();let y=!1;function S(){y||(y=!0,M.then(C))}function b(e){h.push(e)}const g=new Set;let p=0;function C(){const e=v;do{for(;p<c.length;){const t=c[p];p++,d(t),z(t.$$)}for(d(null),c.length=0,p=0;w.length;)w.pop()();for(let t=0;t<h.length;t+=1){const n=h[t];g.has(n)||(g.add(n),n())}h.length=0}while(c.length);for(;k.length;)k.pop()();y=!1,g.clear(),d(e)}function z(e){if(e.fragment!==null){e.update(),m(e.before_update);const t=e.dirty;e.dirty=[-1],e.fragment&&e.fragment.p(e.ctx,t),e.after_update.forEach(b)}}const J=new Set;function W(e,t){e&&e.i&&(J.delete(e),e.i(t))}function B(e,t,n,i){const{fragment:r,after_update:o}=e.$$;r&&r.m(t,n),i||b(()=>{const l=e.$$.on_mount.map(E).filter(I);e.$$.on_destroy?e.$$.on_destroy.push(...l):m(l),e.$$.on_mount=[]}),o.forEach(b)}function F(e,t){const n=e.$$;n.fragment!==null&&(m(n.on_destroy),n.fragment&&n.fragment.d(t),n.on_destroy=n.fragment=null,n.ctx=[])}function D(e,t){e.$$.dirty[0]===-1&&(c.push(e),S(),e.$$.dirty.fill(0)),e.$$.dirty[t/31|0]|=1<<t%31}function K(e,t,n,i,r,o,l,O=[-1]){const f=v;d(e);const s=e.$$={fragment:null,ctx:[],props:o,update:u,not_equal:r,bound:L(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(t.context||(f?f.$$.context:[])),callbacks:L(),dirty:O,skip_bound:!1,root:t.target||f.$$.root};l&&l(s.root);let _=!1;if(s.ctx=n?n(e,t.props||{},(a,$,...x)=>{const q=x.length?x[0]:$;return s.ctx&&r(s.ctx[a],s.ctx[a]=q)&&(!s.skip_bound&&s.bound[a]&&s.bound[a](q),_&&D(e,a)),$}):[],s.update(),_=!0,m(s.before_update),s.fragment=i?i(s.ctx):!1,t.target){if(t.hydrate){const a=A(t.target);s.fragment&&s.fragment.l(a),a.forEach(j)}else s.fragment&&s.fragment.c();t.intro&&W(e.$$.fragment),B(e,t.target,t.anchor,t.customElement),C()}d(f)}class Q{$destroy(){F(this,1),this.$destroy=u}$on(t,n){if(!I(n))return u;const i=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return i.push(n),()=>{const r=i.indexOf(n);r!==-1&&i.splice(r,1)}}$set(t){this.$$set&&!H(t)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}function U(e){let t;return{c(){t=T("main"),t.innerHTML=`<div class="headerTitle svelte-1nnahqd"><span><h1 class="title"><img src="./logo.png" class="topLogo" alt="FLL Hydrog\xE8ne"/>Hydrog\xE8ne</h1></span></div> 
  <hr class="hr1"/> 
  ...
  <footer><p>\xA9 Copyright 2022 - JetWig &amp; imbwbl</p> 
    <i class="fa-brands fa-github"><a href="https://github.com/Imbwbl">\xA0 -- @JetWig</a></i> 
    <br/> 
    <br/> 
    <i class="fa-brands fa-github"><a href="https://github.com/JetWig">\xA0 -- @imbwbl</a></i></footer>`},m(n,i){P(n,t,i)},p:u,i:u,o:u,d(n){n&&j(t)}}}class G extends Q{constructor(t){super(),K(this,t,null,U,N,{})}}new G({target:document.getElementById("app")});
