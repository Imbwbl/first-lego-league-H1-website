(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function n(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerpolicy&&(o.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?o.credentials="include":r.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=n(r);fetch(r.href,o)}})();function a(){}function E(e){return e()}function L(){return Object.create(null)}function h(e){e.forEach(E)}function j(e){return typeof e=="function"}function N(e,t){return e!=e?t==t:e!==t||e&&typeof e=="object"||typeof e=="function"}function H(e){return Object.keys(e).length===0}function P(e,t,n){e.insertBefore(t,n||null)}function I(e){e.parentNode&&e.parentNode.removeChild(e)}function T(e){return document.createElement(e)}function A(e){return Array.from(e.childNodes)}let _;function d(e){_=e}const c=[],k=[],m=[],w=[],M=Promise.resolve();let y=!1;function S(){y||(y=!0,M.then(O))}function v(e){m.push(e)}const g=new Set;let p=0;function O(){const e=_;do{for(;p<c.length;){const t=c[p];p++,d(t),z(t.$$)}for(d(null),c.length=0,p=0;k.length;)k.pop()();for(let t=0;t<m.length;t+=1){const n=m[t];g.has(n)||(g.add(n),n())}m.length=0}while(c.length);for(;w.length;)w.pop()();y=!1,g.clear(),d(e)}function z(e){if(e.fragment!==null){e.update(),h(e.before_update);const t=e.dirty;e.dirty=[-1],e.fragment&&e.fragment.p(e.ctx,t),e.after_update.forEach(v)}}const B=new Set;function F(e,t){e&&e.i&&(B.delete(e),e.i(t))}function D(e,t,n,i){const{fragment:r,after_update:o}=e.$$;r&&r.m(t,n),i||v(()=>{const l=e.$$.on_mount.map(E).filter(j);e.$$.on_destroy?e.$$.on_destroy.push(...l):h(l),e.$$.on_mount=[]}),o.forEach(v)}function K(e,t){const n=e.$$;n.fragment!==null&&(h(n.on_destroy),n.fragment&&n.fragment.d(t),n.on_destroy=n.fragment=null,n.ctx=[])}function Q(e,t){e.$$.dirty[0]===-1&&(c.push(e),S(),e.$$.dirty.fill(0)),e.$$.dirty[t/31|0]|=1<<t%31}function U(e,t,n,i,r,o,l,C=[-1]){const f=_;d(e);const s=e.$$={fragment:null,ctx:[],props:o,update:a,not_equal:r,bound:L(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(t.context||(f?f.$$.context:[])),callbacks:L(),dirty:C,skip_bound:!1,root:t.target||f.$$.root};l&&l(s.root);let b=!1;if(s.ctx=n?n(e,t.props||{},(u,$,...x)=>{const q=x.length?x[0]:$;return s.ctx&&r(s.ctx[u],s.ctx[u]=q)&&(!s.skip_bound&&s.bound[u]&&s.bound[u](q),b&&Q(e,u)),$}):[],s.update(),b=!0,h(s.before_update),s.fragment=i?i(s.ctx):!1,t.target){if(t.hydrate){const u=A(t.target);s.fragment&&s.fragment.l(u),u.forEach(I)}else s.fragment&&s.fragment.c();t.intro&&F(e.$$.fragment),D(e,t.target,t.anchor,t.customElement),O()}d(f)}class G{$destroy(){K(this,1),this.$destroy=a}$on(t,n){if(!j(n))return a;const i=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return i.push(n),()=>{const r=i.indexOf(n);r!==-1&&i.splice(r,1)}}$set(t){this.$$set&&!H(t)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}function J(e){let t;return{c(){t=T("main"),t.innerHTML=`<div class="headerTitle svelte-1nnahqd"><span><h1 class="title"><img src="./logo.png" class="topLogo" alt="FLL Hydrog\xE8ne"/>Hydrog\xE8ne</h1></span></div> 
  <hr class="hr1"/> 
